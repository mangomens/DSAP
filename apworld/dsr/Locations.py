...
"Firelink Shrine": [
    ...
    DSRLocationData(11114928, f"FS: Petrus of Thorolund - Miracle: Heal", f"Miracle: Heal", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114929, f"FS: Petrus of Thorolund - Miracle: Great Heal Excerpt", f"Miracle: Great Heal Excerpt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114930, f"FS: Petrus of Thorolund - Miracle: Homeward", f"Miracle: Homeward", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114931, f"FS: Petrus of Thorolund - Miracle: Force", f"Miracle: Force", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114932, f"FS: Petrus of Thorolund - Miracle: Seek Guidance", f"Miracle: Seek Guidance", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114933, f"FS: Petrus of Thorolund - Talisman", f"Talisman", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114934, f"FS: Petrus of Thorolund - Thorolund Talisman", f"Thorolund Talisman", DSRLocationCategory.SHOP_ITEM),
],  
"Upper Undead Burg - Before Fog": [
...
"Upper Undead Burg": [ # After fog
    ...
    DSRLocationData(11110042, f"UB: Undead Merchant - Residence Key", f"Residence Key", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110823, f"UB: Undead Merchant - Bottomless Box", f"Bottomless Box", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110824, f"UB: Undead Merchant - Repairbox", f"Repairbox", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110901, f"UB: Undead Merchant - Repair Powder", f"Repair Powder", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110902, f"UB: Undead Merchant - Throwing Knife", f"Throwing Knife", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110903, f"UB: Undead Merchant - Firebomb", f"Firebomb", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110904, f"UB: Undead Merchant - Lloyd's Talisman", f"Lloyd's Talisman", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110934, f"UB: Undead Merchant - Dried Finger", f"Dried Finger", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110900, f"UB: Undead Merchant - Orange Guidance Soapstone", f"Orange Guidance Soapstone", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110907, f"UB: Undead Merchant - Dagger", f"Dagger", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110908, f"UB: Undead Merchant - Shortsword", f"Shortsword", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110910, f"UB: Undead Merchant - Scimitar", f"Scimitar", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110911, f"UB: Undead Merchant - Rapier", f"Rapier", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110912, f"UB: Undead Merchant - Hand Axe", f"Hand Axe", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110913, f"UB: Undead Merchant - Club", f"Club", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110914, f"UB: Undead Merchant - Reinforced Club", f"Reinforced Club", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110915, f"UB: Undead Merchant - Spear", f"Spear", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110916, f"UB: Undead Merchant - Short Bow", f"Short Bow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110917, f"UB: Undead Merchant - East-West Shield", f"East-West Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110918, f"UB: Undead Merchant - Small Leather Shield", f"Small Leather Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110919, f"UB: Undead Merchant - Buckler", f"Buckler", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110920, f"UB: Undead Merchant - Leather Shield", f"Leather Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110921, f"UB: Undead Merchant - Heater Shield", f"Heater Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110922, f"UB: Undead Merchant - Warrior's Round Shield", f"Warrior's Round Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110923, f"UB: Undead Merchant - Standard Arrow", f"Standard Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110924, f"UB: Undead Merchant - Large Arrow", f"Large Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110925, f"UB: Undead Merchant - Wooden Arrow", f"Wooden Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110926, f"UB: Undead Merchant - Standard Bolt", f"Standard Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110927, f"UB: Undead Merchant - Heavy Bolt", f"Heavy Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110928, f"UB: Undead Merchant - Wood Bolt", f"Wood Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110929, f"UB: Undead Merchant - Chain Helm", f"Chain Helm", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110930, f"UB: Undead Merchant - Chain Armor", f"Chain Armor", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110931, f"UB: Undead Merchant - Leather Gauntlets", f"Leather Gauntlets", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110932, f"UB: Undead Merchant - Chain Leggings", f"Chain Leggings", DSRLocationCategory.SHOP_ITEM),
...
"Undead Parish": [ # After Fog
    ...
    DSRLocationData(11113904, f"UP: Andre - Repairbox", f"Repairbox", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113905, f"UP: Andre - Longsword", f"Longsword", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113906, f"UP: Andre - BroadSword", f"BroadSword", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113907, f"UP: Andre - Bastard Sword", f"Bastard Sword", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113908, f"UP: Andre - Battle Axe", f"Battle Axe", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113909, f"UP: Andre - Warpick", f"Warpick", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113910, f"UP: Andre - Caestus", f"Caestus", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113911, f"UP: Andre - Pike", f"Pike", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113912, f"UP: Andre - Large Leather Shield", f"Large Leather Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113913, f"UP: Andre - Tower Kite Shield", f"Tower Kite Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113914, f"UP: Andre - Caduceus Kite Shield", f"Caduceus Kite Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113915, f"UP: Andre - Standard Arrow", f"Standard Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113916, f"UP: Andre - Large Arrow", f"Large Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113917, f"UP: Andre - Wooden Arrow", f"Wooden Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113918, f"UP: Andre - Standard Bolt", f"Standard Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113919, f"UP: Andre - Heavy Bolt", f"Heavy Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11113920, f"UP: Andre - Wood Bolt", f"Wood Bolt", DSRLocationCategory.SHOP_ITEM),
...
"Undead Parish - Bell Gargoyles": [
    ...
    # DSRLocationData(11114902, f"UP: Oswald - Indictment", f"Indictment", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114908, f"UP: Oswald - Homeward Bone", f"Homeward Bone", DSRLocationCategory.SHOP_ITEM),
    # DSRLocationData(11114909, f"UP: Oswald - Book of the Guilty", f"Book of the Guilty", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114903, f"UP: Oswald - Miracle: Karmic Justice", f"Miracle: Karmic Justice", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114904, f"UP: Oswald - Velka's Talisman", f"Velka's Talisman", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114905, f"UP: Oswald - Bloodbite Ring", f"Bloodbite Ring", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114906, f"UP: Oswald - Poisonbite Ring", f"Poisonbite Ring", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114907, f"UP: Oswald - Ring of Sacrifice", f"Ring of Sacrifice", DSRLocationCategory.SHOP_ITEM),
],
"Firelink Shrine - After Undead Parish Elevator": [
...
"Lower Undead Burg": [
    ...
    DSRLocationData(11112900, f"LB: Undead Burg Female Merchant - Bloodred Moss Clump", f"Bloodred Moss Clump", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112901, f"LB: Undead Burg Female Merchant - Purple Moss Clump", f"Purple Moss Clump", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112902, f"LB: Undead Burg Female Merchant - Blooming Purple Moss Clump", f"Blooming Purple Moss Clump", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112903, f"LB: Undead Burg Female Merchant - Poison Throwing Knife", f"Poison Throwing Knife", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112904, f"LB: Undead Burg Female Merchant - Dung Pie", f"Dung Pie", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112905, f"LB: Undead Burg Female Merchant - Alluring Skull", f"Alluring Skull", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112906, f"LB: Undead Burg Female Merchant - Charcoal Pine Resin", f"Charcoal Pine Resin", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112907, f"LB: Undead Burg Female Merchant - Transient Curse", f"Transient Curse", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112908, f"LB: Undead Burg Female Merchant - Rotten Pine Resin", f"Rotten Pine Resin", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112909, f"LB: Undead Burg Female Merchant - Homeward Bone", f"Homeward Bone", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112910, f"LB: Undead Burg Female Merchant - Prism Stone", f"Prism Stone", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112911, f"LB: Undead Burg Female Merchant - Humanity", f"Humanity", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112914, f"LB: Undead Burg Female Merchant - Purging Stone", f"Purging Stone", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112912, f"LB: Undead Burg Female Merchant - Fire Arrow", f"Fire Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112913, f"LB: Undead Burg Female Merchant - Poison Arrow", f"Poison Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112915, f"LB: Undead Burg Female Merchant - Standard Arrow", f"Standard Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112916, f"LB: Undead Burg Female Merchant - Large Arrow", f"Large Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112917, f"LB: Undead Burg Female Merchant - Wooden Arrow", f"Wooden Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112918, f"LB: Undead Burg Female Merchant - Standard Bolt", f"Standard Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112919, f"LB: Undead Burg Female Merchant - Heavy Bolt", f"Heavy Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112920, f"LB: Undead Burg Female Merchant - Wood Bolt", f"Wood Bolt", DSRLocationCategory.SHOP_ITEM),
],
"Lower Undead Burg - Capra Demon": [
...
"Lower Undead Burg - After Residence Key": [
    ...
    DSRLocationData(11114910, f"UB: Griggs of Vinheim - Sorcery: Soul Arrow", f"Sorcery: Soul Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114911, f"UB: Griggs of Vinheim - Sorcery: Great Soul Arrow", f"Sorcery: Great Soul Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114912, f"UB: Griggs of Vinheim - Sorcery: Heavy Soul Arrow", f"Sorcery: Heavy Soul Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114913, f"UB: Griggs of Vinheim - Sorcery: Great Heavy Soul Arrow", f"Sorcery: Great Heavy Soul Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114914, f"UB: Griggs of Vinheim - Sorcery: Magic Weapon", f"Sorcery: Magic Weapon", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114915, f"UB: Griggs of Vinheim - Sorcery: Magic Shield", f"Sorcery: Magic Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114916, f"UB: Griggs of Vinheim - Sorcery: Aural Decoy", f"Sorcery: Aural Decoy", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114917, f"UB: Griggs of Vinheim - Sorcery: Fall Control", f"Sorcery: Fall Control", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114918, f"UB: Griggs of Vinheim - Bellowing Dragoncrest Ring", f"Bellowing Dragoncrest Ring", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114919, f"UB: Griggs of Vinheim - Lingering Dragoncrest Ring", f"Lingering Dragoncrest Ring", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114920, f"UB: Griggs of Vinheim - Sorcerer's Catalyst", f"Sorcerer's Catalyst", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114921, f"UB: Griggs of Vinheim - Sorcery: Homing Soulmass", f"Sorcery: Homing Soulmass", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114922, f"UB: Griggs of Vinheim - Sorcery: Soul Spear", f"Sorcery: Soul Spear", DSRLocationCategory.SHOP_ITEM),
],
"Watchtower Basement": [
...
"Depths": [
    ...
    DSRLocationData(11114923, f"DE: Laurentius of the Great Swamp - Pyromancy: Fireball", f"Pyromancy: Fireball", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114924, f"DE: Laurentius of the Great Swamp - Pyromancy: Fire Orb", f"Pyromancy: Fire Orb", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114925, f"DE: Laurentius of the Great Swamp - Pyromancy: Combustion", f"Pyromancy: Combustion", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114926, f"DE: Laurentius of the Great Swamp - Pyromancy: Iron Flesh", f"Pyromancy: Iron Flesh", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114927, f"DE: Laurentius of the Great Swamp - Pyromancy: Flash Sweat", f"Pyromancy: Flash Sweat", DSRLocationCategory.SHOP_ITEM),
],
"Depths - Gaping Dragon": [
...
"Darkroot Basin": [
    ...
    DSRLocationData(11114935, f"DB: Dusk of Oolacile - Sorcery: Hidden Weapon", f"Sorcery: Hidden Weapon", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114936, f"DB: Dusk of Oolacile - Sorcery: Hidden Body", f"Sorcery: Hidden Body", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114937, f"DB: Dusk of Oolacile - Sorcery: Cast Light", f"Sorcery: Cast Light", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114938, f"DB: Dusk of Oolacile - Sorcery: Repair", f"Sorcery: Repair", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114939, f"DB: Dusk of Oolacile - Sorcery: Chameleon", f"Sorcery: Chameleon", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11114940, f"DB: Dusk of Oolacile - Oolacile Ivory Catalyst", f"Oolacile Ivory Catalyst", DSRLocationCategory.SHOP_ITEM),
],
"Darkroot Garden - Before Fog": [
...
"Upper New Londo Ruins - After Fog": [
    ...
    DSRLocationData(11113000, f"NL: Ingward - Resist Curse", f"Sorcery: Resist Curse", DSRLocationCategory.SHOP_ITEM),
