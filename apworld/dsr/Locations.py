...
"Upper Undead Burg": [ # After fog
    ...
    DSRLocationData(11110900, f"UB: Shop - Orange Guidance Soapstone", f"Orange Guidance Soapstone", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110901, f"UB: Repair Powder", f"Repair Powder", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110902, f"UB: Shop - Throwing Knife", f"Throwing Knife", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110903, f"UB: Firebomb", f"Firebomb", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110904, f"UB: Lloyd's Talisman", f"Lloyd's Talisman", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110907, f"UB: Dagger", f"Dagger", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110908, f"UB: Shortsword", f"Shortsword", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110910, f"UB: Scimitar", f"Scimitar", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110911, f"UB: Rapier", f"Rapier", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110912, f"UB: Hand Axe", f"Hand Axe", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110913, f"UB: Club", f"Club", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110914, f"UB: Reinforced Club", f"Reinforced Club", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110915, f"UB: Spear", f"Spear", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110916, f"UB: Short Bow", f"Short Bow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110917, f"UB: East-West Shield", f"East-West Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110918, f"UB: Small Leather Shield", f"Small Leather Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110919, f"UB: Buckler", f"Buckler", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110920, f"UB: Leather Shield", f"Leather Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110921, f"UB: Heater Shield", f"Heater Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110922, f"UB: Warrior's Round Shield", f"Warrior's Round Shield", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110923, f"UB: Standard Arrow", f"Standard Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110924, f"UB: Large Arrow", f"Large Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110925, f"UB: Wooden Arrow", f"Wooden Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110926, f"UB: Shop - Standard Bolt", f"Standard Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110927, f"UB: Heavy Bolt", f"Heavy Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110928, f"UB: Wood Bolt", f"Wood Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110929, f"UB: Chain Helm", f"Chain Helm", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110930, f"UB: Chain Armor", f"Chain Armor", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110931, f"UB: Leather Gauntlets", f"Leather Gauntlets", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110932, f"UB: Chain Leggings", f"Chain Leggings", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110934, f"UB: Dried Finger", f"Dried Finger", DSRLocationCategory.SHOP_ITEM),
...
"Lower Undead Burg": [
    ...
    DSRLocationData(11112901, f"LB: Female Merchant - Purple Moss Clump", f"Purple Moss Clump", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112902, f"LB: Female Merchant - Blooming Purple Moss Clump", f"Blooming Purple Moss Clump", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112903, f"LB: Female Merchant - Poison Throwing Knife", f"Poison Throwing Knife", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112904, f"LB: Female Merchant - Dung Pie", f"Dung Pie", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112905, f"LB: Female Merchant - Alluring Skull", f"Alluring Skull", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112906, f"LB: Female Merchant - Charcoal Pine Resin", f"Charcoal Pine Resin", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112907, f"LB: Female Merchant - Transient Curse", f"Transient Curse", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112908, f"LB: Female Merchant - Rotten Pine Resin", f"Rotten Pine Resin", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112909, f"LB: Female Merchant - Homeward Bone", f"Homeward Bone", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112910, f"LB: Female Merchant - Prism Stone", f"Prism Stone", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112911, f"LB: Female Merchant - Humanity", f"Humanity", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112912, f"LB: Female Merchant - Fire Arrow", f"Fire Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112913, f"LB: Female Merchant - Poison Arrow", f"Poison Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112914, f"LB: Female Merchant - Purging Stone", f"Purging Stone", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112915, f"LB: Female Merchant - Standard Arrow", f"Standard Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112916, f"LB: Female Merchant - Large Arrow", f"Large Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112917, f"LB: Female Merchant - Wooden Arrow", f"Wooden Arrow", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112918, f"LB: Female Merchant - Standard Bolt", f"Standard Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112919, f"LB: Female Merchant - Heavy Bolt", f"Heavy Bolt", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11112920, f"LB: Female Merchant - Wood Bolt", f"Wood Bolt", DSRLocationCategory.SHOP_ITEM),
],
"Lower Undead Burg - Capra Demon": [
